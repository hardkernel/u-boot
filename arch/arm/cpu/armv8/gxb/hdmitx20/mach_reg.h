...
#define P_PREG_PAD_GPIO6_EN_N (0xc8834400 + (0x08 << 2))
#define P_PREG_PAD_GPIO6_O (0xc8834400 + (0x09 << 2))
#define P_PREG_PAD_GPIO6_I (0xc8834400 + (0x0a << 2))
#define P_PREG_JTAG_GPIO_ADDR (0xc8834400 + (0x0b << 2))
#define P_PREG_PAD_GPIO0_EN_N (0xc8834400 + (0x0c << 2))
#define P_PREG_PAD_GPIO0_O (0xc8834400 + (0x0d << 2))
#define P_PREG_PAD_GPIO0_I (0xc8834400 + (0x0e << 2))
#define P_PREG_PAD_GPIO1_EN_N (0xc8834400 + (0x0f << 2))
#define P_PREG_PAD_GPIO1_O (0xc8834400 + (0x10 << 2))
#define P_PREG_PAD_GPIO1_I (0xc8834400 + (0x11 << 2))
#define P_PREG_PAD_GPIO2_EN_N (0xc8834400 + (0x12 << 2))
#define P_PREG_PAD_GPIO2_O (0xc8834400 + (0x13 << 2))
#define P_PREG_PAD_GPIO2_I (0xc8834400 + (0x14 << 2))
#define P_PREG_PAD_GPIO3_EN_N (0xc8834400 + (0x15 << 2))
#define P_PREG_PAD_GPIO3_O (0xc8834400 + (0x16 << 2))
#define P_PREG_PAD_GPIO3_I (0xc8834400 + (0x17 << 2))
#define P_PREG_PAD_GPIO4_EN_N (0xc8834400 + (0x18 << 2))
#define P_PREG_PAD_GPIO4_O (0xc8834400 + (0x19 << 2))
#define P_PREG_PAD_GPIO4_I (0xc8834400 + (0x1a << 2))
#define P_PREG_PAD_GPIO5_EN_N (0xc8834400 + (0x1b << 2))
#define P_PREG_PAD_GPIO5_O (0xc8834400 + (0x1c << 2))
#define P_PREG_PAD_GPIO5_I (0xc8834400 + (0x1d << 2))
