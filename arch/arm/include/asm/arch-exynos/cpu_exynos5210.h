...
#ifndef _EXYNOS5210_CPU_H
#define _EXYNOS5210_CPU_H

/* EXYNOS5210 */
#define EXYNOS5210_PRO_ID		0x10000000
#define EXYNOS5210_SYSREG_BASE	        0x10050000
#define EXYNOS5210_POWER_BASE	        0x10040000
#define EXYNOS5210_CLOCK_BASE	        0x10010000
#define EXYNOS5210_SROM_BASE	        0x12250000
#define EXYNOS5210_HSMMC_BASE	        0x12200000
#define EXYNOS5210_PWMTIMER_BASE	0x12DD0000
#define EXYNOS5210_INF_REG_BASE	        0x10040800
#define EXYNOS5210_TZPC_BASE		0x10100000
#define EXYNOS5210_UART_BASE       	0x12C00000
...
#define USB_CFG_REG			(EXYNOS5210_SYSREG_BASE + USB_CFG_OFFSET)

/*
 * POWER
 */
#define ELFIN_POWER_BASE                EXYNOS5210_POWER_BASE
#define OMR_OFFSET			0x0
#define SW_RST_REG_OFFSET		0x400
#define SW_RST_REG			__REG(EXYNOS5210_POWER_BASE + SW_RST_REG_OFFSET)

#define INF_REG_BASE			EXYNOS5210_INF_REG_BASE
...
#define USB_DEVICE_PHY_CONTROL			(EXYNOS5210_POWER_BASE+USB_DEVICE_PHY_CONTROL_OFFSET)
 ...
 * CLOCK
 */
#define ELFIN_CLOCK_BASE		EXYNOS5210_CLOCK_BASE
...
#define CLK_SRC_DISP0_0_OFFSET                 0x10224
#define CLK_SRC_DISP0_1_OFFSET                 0x10228
...
#define CLK_SRC_MASK_DISP0_0_OFFSET            0x10324
#define CLK_SRC_MASK_DISP0_1_OFFSET            0x10328
...
#define CLK_DIV_DISP0_0_OFFSET                 0x10524
#define CLK_DIV_DISP0_1_OFFSET                 0x10528
...
#define CLK_DIV_STAT_DISP0_0_OFFSET            0x10624
#define CLK_DIV_STAT_DISP0_1_OFFSET            0x10628
...
#define CLK_GATE_TOP_SCLK_DISP0_OFFSET         0x10824
...
#define CLK_GATE_IP_DISP0_OFFSET               0x10924
...
#define ELFIN_TZPC0_BASE		(EXYNOS5210_TZPC_BASE + TZPC0_OFFSET)
#define ELFIN_TZPC1_BASE		(EXYNOS5210_TZPC_BASE + TZPC1_OFFSET)
#define ELFIN_TZPC2_BASE		(EXYNOS5210_TZPC_BASE + TZPC2_OFFSET)
#define ELFIN_TZPC3_BASE		(EXYNOS5210_TZPC_BASE + TZPC3_OFFSET)
#define ELFIN_TZPC4_BASE		(EXYNOS5210_TZPC_BASE + TZPC4_OFFSET)
#define ELFIN_TZPC5_BASE		(EXYNOS5210_TZPC_BASE + TZPC5_OFFSET)
#define ELFIN_TZPC6_BASE		(EXYNOS5210_TZPC_BASE + TZPC6_OFFSET)
#define ELFIN_TZPC7_BASE		(EXYNOS5210_TZPC_BASE + TZPC7_OFFSET)
#define ELFIN_TZPC8_BASE		(EXYNOS5210_TZPC_BASE + TZPC8_OFFSET)
#define ELFIN_TZPC9_BASE		(EXYNOS5210_TZPC_BASE + TZPC9_OFFSET)
 ...
 * Memory controller
 */
#define ELFIN_SROM_BASE			EXYNOS5210_SROM_BASE
 ...
 * SDRAM Controller
 */
#define APB_DMC_0_BASE			0x10C00000
#define APB_DMC_1_BASE			0x10C10000
...
#define UART_CONSOLE_BASE (EXYNOS5210_UART_BASE + UART0_OFFSET)
#elif defined(CONFIG_SERIAL1)
#define UART_CONSOLE_BASE (EXYNOS5210_UART_BASE  + UART1_OFFSET)
#elif defined(CONFIG_SERIAL2)
#define UART_CONSOLE_BASE (EXYNOS5210_UART_BASE + UART2_OFFSET)
#elif defined(CONFIG_SERIAL3)
#define UART_CONSOLE_BASE (EXYNOS5210_UART_BASE + UART3_OFFSET)
#else
#define UART_CONSOLE_BASE (EXYNOS5210_UART_BASE + UART0_OFFSET)
#endif
...
#define ELFIN_HSMMC_0_BASE		(EXYNOS5210_HSMMC_BASE + HSMMC_0_OFFSET)
#define ELFIN_HSMMC_1_BASE		(EXYNOS5210_HSMMC_BASE + HSMMC_1_OFFSET)
#define ELFIN_HSMMC_2_BASE		(EXYNOS5210_HSMMC_BASE + HSMMC_2_OFFSET)
#define ELFIN_HSMMC_3_BASE		(EXYNOS5210_HSMMC_BASE + HSMMC_3_OFFSET)
/* Don't use it */
#define ELFIN_HSMMC_4_BASE		(EXYNOS5210_HSMMC_BASE + HSMMC_4_OFFSET)
