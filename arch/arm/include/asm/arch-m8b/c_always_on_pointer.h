...
#define P_AO_RTI_GEN_PWR_ACK0       (volatile unsigned long *)(0xc8100000 | (0x00 << 10) | (0x3c << 2))
#define P_AO_RTI_PWR_A9_MEM_PD0     (volatile unsigned long *)(0xc8100000 | (0x00 << 10) | (0x3d << 2))
#define P_AO_RTI_PWR_A9_MEM_PD1     (volatile unsigned long *)(0xc8100000 | (0x00 << 10) | (0x3e << 2))
