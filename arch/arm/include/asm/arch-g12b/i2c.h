...
#define MESON_I2C_MASTER_AO_GPIOAO_2_REG	(P_AO_RTI_PINMUX_REG0) /* P_AO_RTI_PIN_MUX_REG */
#define MESON_I2C_MASTER_AO_GPIOAO_2_BIT	(1<<8)
#define MESON_I2C_MASTER_AO_GPIOAO_3_REG	(P_AO_RTI_PINMUX_REG0) /* P_AO_RTI_PIN_MUX_REG */
#define MESON_I2C_MASTER_AO_GPIOAO_3_BIT	(1<<12)
