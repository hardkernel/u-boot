...
/*i2c master d*/
#define MESON_I2C_MASTER_D_GPIOH_7_REG		CBUS_REG_ADDR(PERIPHS_PIN_MUX_4)
#define MESON_I2C_MASTER_D_GPIOH_7_BIT		(1<<3)
#define MESON_I2C_MASTER_D_GPIOH_8_REG		CBUS_REG_ADDR(PERIPHS_PIN_MUX_4)
#define MESON_I2C_MASTER_D_GPIOH_8_BIT		(1<<2)
