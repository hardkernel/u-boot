...
uchar default_environment[] = {
    ...
    "extra_arg_2=0\0"
    "extra_arg_3=0\0"
    "cfg_file_name=boot.ini\0"
    "cfg_load_base_mem=41000000\0"
    "cfg_load_device=0\0"
    "cfg_load_partition=1\0"
    "cfg_load_partition_type=fat\0"
    ...
    #endif
    #if defined(CONFIG_UBOOT_ERASE_EVN)
        "erase_uboot_env=" CONFIG_UBOOT_ERASE_EVN "\0"
    #endif
#endif    
