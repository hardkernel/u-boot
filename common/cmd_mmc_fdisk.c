...
///////////////////////////////////////////////////////////	
    ...
    if (flag)
        ...
        if (sdInfo.total_block_count > FAT_PART_BLOCK_MAX)
            part_size = (unsigned long long)USER_DATA_PART_SIZE_BIG * MB_SIZE;
        else
...
///////////////////////////////////////////////////////////	
    ...
    if(sdInfo.total_block_count - block_start > FAT_PART_BLOCK_MAX) {
        part_size = (unsigned long long)FAT_PART_MAX_SIZE * MB_SIZE;
    	block_offset = calc_unit(part_size, sdInfo);
    	printf("Warning!! Max FAT32 Size is 32GB.. FAT 32GB Fix..\n");
    }
