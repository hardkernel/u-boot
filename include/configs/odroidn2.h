...
#define CONFIG_IR_REMOTE_POWER_UP_KEY_VAL1 0x23DC4DB2 /* hardkernel ir - power key */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "boot_part=boot\0"\
        "initargs="\
            "rootfstype=ramfs init=/init console=ttyS0,115200 no_console_suspend earlycon=aml-uart,0xff803000 ramoops.pstore_en=1 ramoops.record_size=0x8000 ramoops.console_size=0x4000 "\
            "\0"\
        "upgrade_check="\
