...
#define CONFIG_MACH_XYREF5422	/* which is in a XYREF5422 */
...
#define EMMC_DEV_OFFSET				0x00000014
    ...
    #define CONFIG_UBOOT_COPY_EMMC2SD   \
		...
		"mmc write 1 0x40008000 0x4CF 0x20;"
    #define CONFIG_ERASE_UBOOT_ENV_CMD  \
		"mmc write 0 0x40008000 0x4CF 0x20;"
#else
	#ifdef CONFIG_CPU_EXYNOS5422_EVT0
	#ifdef CONFIG_SECURE_BOOT
...
#if defined(CONFIG_BOARD_HARDKERNEL)
    #define CONFIG_SYS_PROMPT		"Exynos5422 # "
    #define CONFIG_SYS_CBSIZE		512	/* Console I/O Buffer Size */
    #define CONFIG_SYS_PBSIZE		(CONFIG_SYS_CBSIZE + sizeof(CONFIG_SYS_PROMPT) + 16)	/* Print Buffer Size */
    #define CONFIG_SYS_MAXARGS		32	/* max number of command args */
#else
	#define CONFIG_SYS_PROMPT		"XYREF5422 # "
...
#if defined(CONFIG_BOARD_HARDKERNEL)
    #define CONFIG_IDENT_STRING		" for Exynos5422"
#else
	#define CONFIG_IDENT_STRING		" for XYREF5422"
#endif
