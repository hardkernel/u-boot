...
#if defined(CONFIG_CPU_EXYNOS5210) || defined(CONFIG_ARCH_EXYNOS5)
#include <command.h>
#include <asm/errno.h>
#include <asm/io.h>
...
static void exynoy_usb_phy_on(void)
{
...
static void exynos_usb_wait_cable_insert(void)
{
	u32 tmp;
	int ucFirst = 1;
