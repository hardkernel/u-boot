...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "upgrade_check="\
            ...
            "\0"\
        "storeargs="\
            "setenv bootargs ${initargs} ${fs_type} androidboot.selinux=${EnableSelinux} logo=${display_layer},loaded,${fb_addr},${outputmode} vout=${outputmode},enable hdmimode=${hdmimode} cvbsmode=${cvbsmode} hdmitx=${cecconfig} cvbsdrv=${cvbs_drv} androidboot.firstboot=${firstboot} jtag=${jtag}; "\
