...
/*
 * board/amlogic/axg_s410_v1/axg_s410_v1.c
 *
...
int board_late_init(void){
	...
	run_command("gpio clear GPIOZ_4", 1);
	return 0;
}
#endif
...
int checkhw(char * name)
{
	...
	case 1:
	case 2:
		strcpy(loc_name, "axg_s410_1g\0");
		break;
	case 3:
		strcpy(loc_name, "axg_s410_v03\0");
		break;
	default:
		strcpy(loc_name, "axg_s410_1g");
		break;
	}
	if (name != NULL)
