...
int checkhw(char * name)
{
	...
	switch (hwid) {
		case 1:
			strcpy(loc_name, "txl_p323_v1\0");
			break;
		case 2:
			switch (ddr_size) {
				case 0x80000000:
					strcpy(loc_name, "txl_p323_v2-2g\0");
					break;
				case 0x40000000:
					strcpy(loc_name, "txl_p323_v2-1g\0");
					break;
				default:
					strcpy(loc_name, "txl_p323_unsupport");
					break;
				}
			break;
		default:
			strcpy(loc_name, "txl_p323_v1");
			break;
	}
